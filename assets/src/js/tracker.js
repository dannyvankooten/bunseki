(function() { 
  ...
  function findTrackerUrl() {
    const el = document.getElementById('bunseki-script')
  ...
  function trackPageview(vars) { 
    ...
    img.addEventListener('load', function() {
      ...
      setCookie('_bunseki', JSON.stringify(data), { expires: midnight, path: '/' });
  ...
  // override global bunseki object
  window.bunseki = function() {
  ...
  queue.forEach((i) => bunseki.apply(this, i));
})()
